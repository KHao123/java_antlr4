...
public class Standardizer extends JavaParserBaseListener{
    ...
    Map<String,String> classNameModify=new HashMap<>();
    Map<String,String> methodNameModify=new HashMap<>();
    Map<String,String> constNameModify=new HashMap<>();
    Map<String,String> nonconstNameModify=new HashMap<>();
    int tabCnt=0;
...
//        }
    ...
    static String underline2Camel(String line, boolean upperCamel) {
